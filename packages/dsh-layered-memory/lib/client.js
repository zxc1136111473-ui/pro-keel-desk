...
var __defProp = Object.defineProperty;
		...
		var zh = {
		  ...
		  "ov.empty.body": "继续对话即可形成记忆。不需要时，在自动化里关闭捕获。",
		  "ov.empty.capture": "捕获",
		  "ov.empty.distill": "蒸馏",
		  "ov.empty.recall": "召回",
		  "ov.empty.capOk": "",
		  ...
		  "au.sw.capture": "捕获",
		  "au.sw.captureD": "把对话写入记忆。关闭后不再捕获新对话",
		  "au.sw.distill": "蒸馏",
		...
		var en = {
		  ...
		  "ov.empty.body": "Keep chatting to form memories. Turn capture off in Automation if you do not want that.",
		  ...
		  "au.sw.captureD": "Write the conversation into memory. Turn off to stop capturing new turns",
